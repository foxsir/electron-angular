 ...
 */
export default class MBQoS4ReciveDaemon {

  readonly TAG = "MBQoS4ReciveDaemon";
  ...
  MESSAGES_VALID_TIME = 10 * 60 * 1000;// 10分钟
  ...
  addRecieved(fingerPrintOfProtocal) {
    if (fingerPrintOfProtocal) {
      ...
      MBUtils.mblog_w(this.TAG, "无效的 fingerPrintOfProtocal==null!");
    }
  }
